...
// Unexpected Parsing from https://www.codewars.com/kata/54fdaa4a50f167b5c000005f
...
console.assert(getStatus(true) === {status: "busy"})
console.assert(getStatus(true) === {status: "available"})
